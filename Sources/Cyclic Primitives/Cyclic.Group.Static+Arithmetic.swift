...
extension Cyclic.Group.Static.Element {
    ...
    public static func + (lhs: Self, rhs: Self) -> Self {
        ...
        let reduced = sum % Self.modulusCardinal
    ...
    @inlinable
    public static func - (lhs: Self, rhs: Self) -> Self {
        // N - b is always valid since rhs.position < modulusCardinal (invariant)
        let inverse = Self.modulusCardinal.subtract.saturating(Cardinal(rhs.position))
...
extension Cyclic.Group.Static.Element {
    ...
    public var inverse: Self {
        ...
        // position < modulusCardinal (invariant), so subtraction is safe
        let inv = Self.modulusCardinal.subtract.saturating(Cardinal(position))
